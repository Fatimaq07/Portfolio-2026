  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-background overflow-hidden">
        ...
        {/* Floating Flowers */}
        <motion.div 
          className="absolute top-[8%] left-[15%] text-3xl md:text-4xl opacity-60"
        ...
        <motion.div 
          className="absolute top-[25%] right-[12%] text-2xl md:text-3xl opacity-50"
        ...
        <motion.div 
          className="absolute top-[45%] left-[5%] text-2xl md:text-3xl opacity-55"
          animate={{ y: [0, -40, 0], x: [0, 25, 0], rotate: [0, 360] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        >
          🌷
        </motion.div>
        <motion.div 
          className="absolute bottom-[35%] right-[8%] text-3xl md:text-4xl opacity-45"
        ...
        <motion.div 
          className="absolute top-[65%] left-[25%] text-xl md:text-2xl opacity-50"
          animate={{ y: [0, -30, 0], rotate: [0, 25, -25, 0] }}
          transition={{ duration: 9, repeat: Infinity, ease: "easeInOut", delay: 1.5 }}
        >
          💐
        </motion.div>
        <motion.div 
          className="absolute top-[12%] right-[45%] text-2xl md:text-3xl opacity-55"
          animate={{ y: [0, 45, 0], x: [0, -30, 0], rotate: [0, -360] }}
          transition={{ duration: 11, repeat: Infinity, ease: "easeInOut", delay: 0.8 }}
        >
          🌻
        </motion.div>
        <motion.div 
          className="absolute bottom-[25%] left-[40%] text-xl md:text-2xl opacity-40"
        ...
        <motion.div 
          className="absolute top-[35%] right-[30%] text-2xl md:text-3xl opacity-50"
        ...
        <motion.div 
          className="absolute bottom-[15%] right-[50%] text-xl md:text-2xl opacity-45"
          animate={{ y: [0, -50, 0], x: [0, 35, 0], rotate: [0, 180, 360] }}
          transition={{ duration: 12, repeat: Infinity, ease: "easeInOut", delay: 0.6 }}
        >
          🏵️
        </motion.div>
        <motion.div 
          className="absolute top-[55%] right-[18%] text-2xl md:text-3xl opacity-55"
        ...
        <motion.div 
          className="absolute bottom-[45%] left-[12%] text-xl md:text-2xl opacity-50"
        ...
        <motion.div 
          className="absolute top-[75%] left-[55%] text-2xl md:text-3xl opacity-40"
          animate={{ y: [0, 35, 0], x: [0, 40, 0], rotate: [0, 15, -15, 0] }}
