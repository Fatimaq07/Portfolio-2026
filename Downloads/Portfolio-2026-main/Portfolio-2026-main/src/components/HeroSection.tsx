...
import profilePhoto from '@/assets/my pic.jpeg';
...
export const HeroSection = () => {
  ...
  return (
    <section 
      ref={containerRef} 
      id="hero" 
      className="relative flex flex-col items-center px-6 lg:px-16 overflow-hidden py-12 md:h-screen"
    >
      ...
      <div className="w-full max-w-[1800px] mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          <div className="scatter-element absolute -top-8 left-0 lg:left-[5%]">
            <span className="text-xl tracking-[0.3em] text-muted-foreground uppercase">Portfolio</span>
            <span className="block text-4xl lg:text-5xl font-bold text-foreground font-serif"></span>
          </div>

          {/* Main Name - Editorial Typography */}
          <div className="pt-16 lg:pt-8 text-center">
  <div className="mx-auto max-w-5xl overflow-hidden">
    <h1
      className="hero-line name-glow font-bold text-foreground tracking-tight font-serif"
  ...
  <div className="mx-auto max-w-5xl overflow-hidden flex flex-col sm:flex-row items-center justify-center gap-4 lg:gap-8">
    <h1
      className="hero-line name-glow font-bold text-primary tracking-tight font-serif text-center"
      style={{ fontSize: 'clamp(3rem, 9vw, 9rem)', lineHeight: '1.2' }}
    >
      QURESHI
    </h1>

    <span className="hero-line letter-animate text-2xl lg:text-4xl text-muted-foreground font-light mb-4 lg:mb-8">
      ©2026
    </span>
  </div>
</div>
          ...
          <div className="profile-editorial relative lg:absolute lg:top-12 lg:right-12 mx-auto w-40 h-48 sm:w-48 sm:h-60 md:w-56 md:h-72 lg:w-64 lg:h-80">
            {/* Click Me Arrow */}
            <motion.div 
              ...
              >
                ...
                >
                  ...
                  <div className="scatter-element absolute -bottom-6 -left-4 bg-primary/10 backdrop-blur-md border border-primary/30 px-3 py-1.5 rounded-sm">
                    <span className="text-[10px] uppercase tracking-widest text-foreground/70"></span>
                  </div>
                </div>
        ...
        <div className="mt-12 lg:mt-16 grid grid-cols-12 gap-4 lg:gap-8">
          ...
          <div className="col-span-12 lg:col-span-3">
            <div className="info-block flex items-center gap-3 overflow-hidden">
              ...
              <span className="typing-text text-sm uppercase tracking-[0.2em] text-foreground whitespace-nowrap overflow-hidden">MERN Stack Developer</span>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-4 lg:col-start-5">
            <p className="info-block text-base lg:text-lg text-muted-foreground leading-relaxed">
              Building intuitive digital experiences with <span className="text-foreground font-medium">MERN Stack</span>, <span className="text-foreground font-medium">AI Automation</span>
            </p>
          </div>
        ...
        {/* CTA Row */}
        <div className="mt-12 lg:mt-16 flex items-center gap-4 lg:gap-6 w-full">
          ...
          {/* Email floating */}
          <div className="cta-editorial hidden lg:flex items-center gap-2 text-muted-foreground">
        ...
        >
          ...
          <span className="text-xs lg:text-sm font-medium text-foreground">Open to Opportunities</span>
        </motion.div>
