...
const VideoCard = ({ 
  ...
  return (
    <motion.div
      layout
      onClick={onClick}
      className={`w-full md:w-auto relative h-64 sm:h-[320px] md:h-[380px] rounded-2xl overflow-hidden cursor-pointer transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] group ${
...
export const VideosSection = () => {
  ...
  return (
    <section className="relative flex flex-col justify-center px-4 py-12 md:h-screen overflow-hidden"
    >
